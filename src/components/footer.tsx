...
export default function Footer() {
  return (
    <div className="w-full text-md flex flex-col gap-1 px-4 items-center justify-center bottom-0 pt-4 md:pt-0">
      <div>
        Feito por{" "}
        <a
          target="_blank"
          href="https://samuelcustodio.com/"
          className="underline text-[#EF0B73]"
        >
          Samuel Custódio
        </a>
      </div>
      <div className="w-full flex items-center justify-center gap-1">
        Me contate:{" "}
        <motion.button
          title="Me veja no Linkedin"
          whileTap={{ scale: 0.98 }}
          whileHover={{ scale: 1.07 }}
        >
          <a target="_blank" href="https://www.linkedin.com/in/samuelcustodio/">
            <svg
        ...
        <motion.button
          title="Me veja no Github"
          whileTap={{ scale: 0.98 }}
          whileHover={{ scale: 1.07 }}
        >
          <a target="_blank" href="https://github.com/SGKolibri">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
              y="0px"
